...
class MyHouse extends CGFobject {
	constructor(scene) {
        ...
        this.marbleHouseMat.loadTexture('textures/marble.jpg');
        ...
        this.yellowHouseMat.loadTexture('textures/yellow.jpg');
        ...
        this.tileHouseMat.loadTexture('textures/tile.jpg');
        ...
        this.doorMat.loadTexture('textures/door.jpg');
        ...
        this.windowHouseMat.loadTexture('textures/window.jpg');
